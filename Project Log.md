...
In other words, I don't know <i>exactly</i> what I'm doing, but I know that I do not want to use the Sparkfun Variable Bootloader, because some future OS/software may need a different bootloader. The Unknown or Bust (The Unknown may also bust/brick:) Known Knowns. Check. Known Unknowns. Check.  
